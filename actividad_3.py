...
#*Se crea una variable que contiene la funcion a evaluar
...
#Aquí se declaran las variables para poder visualizar la función
...
for i in range(num_iteraciones):
    grad_x1, grad_x2 = derivadas #se obtienen las derivadas parciales actuales
    ...
    # Evaluar y luego imprimir el valor de la función en cada iteración
